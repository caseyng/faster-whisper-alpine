...
All existing faster-whisper Docker images use Debian. This is the first Alpine-based image, solving three compatibility issues that block installation on musl systems.
